...
--insert into server(id,name,description) values(1,'MyServer','Big and Shiny');
insert into server(id,name,description) select server_seq.nextval,'MyServer','Small and Shiny' from dual;
insert into server(id,name,description) select server_seq.nextval,'YourServer','Big and Rusy' from dual;